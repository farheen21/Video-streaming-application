  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <li><a href="#bundledependencies">bundleDependencies</a></li>
...
// Not valid metadata
{
  ...
  "config": {
    ...
    <p>See <a href="https://github.com/npm/node-semver#versions">semver</a> for more details about specifying version
      ranges.</p>
    <ul>
      ...
      <li><code>^version</code> "Compatible with version" See <a href="https://github.com/npm/node-semver#versions">semver</a>
      </li>
...
git://github.com/npm/cli.git#v1.0.27
  ...
  "dependencies": {
    ...
    <p>As of version 2.0.0 you can provide a path to a local directory that
      contains a package. Local paths can be saved using <code>npm install -S</code> or <code>npm install --save</code>,
...
/foo/bar
  ...
  "peerDependencies": {
    ...
    <p>This ensures your package <code>tea-latte</code> can be installed <em>along</em> with the
      second major version of the host package <code>tea</code> only. <code>npm install tea-latte</code> could possibly
      yield the following dependency graph:</p>
...
└── tea@2.2.0
  ...
  "bundleDependencies": [
    ...
    <p>we can obtain <code>awesome-web-framework-1.0.0.tgz</code> file by running <code>npm pack</code>.
      ...
      can be installed in a new project by executing <code>npm install awesome-web-framework-1.0.0.tgz</code>. Note that
      the package names do not
    ...
    <p>If a dependency can be used, but you would like npm to proceed if it cannot
      ...
      failures do not cause installation to fail. Running <code>npm install --omit=optional</code> will prevent these
...
if (foo) {
  ...
  "overrides": {
    ...
    <p>The above is a short hand notation, the full object form can be used to allow
      ...
      <code>foo</code> to always be <code>1.0.0</code> while also making <code>bar</code> at any depth beyond
      <code>foo</code>
