  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <li><a href="#auth-related-configuration">Auth related configuration</a></li>
...
@myscope:registry=https://mycustomregistry.example.org
    ...
    <p>The settings <code>_auth</code>, <code>_authToken</code>, <code>username</code> and <code>_password</code> must
      all be
