    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <ul>
          ...
          <li><a href="#cycles-conflicts-and-folder-parsimony">Cycles, Conflicts, and Folder Parsimony</a></li>
...
+-- node_modules
    ...
    <p>This allows a package maintainer to install all of their dependencies
      ...
      cannot be found elsewhere. See <a href="../configuring-npm/package-json.html"><code>package.json</code></a> for
      more information.</p>
