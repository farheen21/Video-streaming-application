  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <li><a href="#using-a-node-version-manager-to-install-nodejs-and-npm">Using a Node version manager to install
        ...
        <ul>
          ...
          <li><a href="#linux-or-other-operating-systems-node-installers">Linux or other operating systems Node
            installers</a></li>
  ...
  <div id="_content"><h3 id="description">Description</h3>
    ...
    <ul>
      <li><a href="#checking-your-version-of-npm-and-node-js">Checking your version of npm and
        Node.js</a></li>
      <li><a href="#using-a-node-version-manager-to-install-node-js-and-npm">Using a Node version manager to install
        Node.js and
        npm</a></li>
...
npm -v
    ...
    <h3 id="using-a-node-version-manager-to-install-nodejs-and-npm">Using a Node version manager to install Node.js and
      npm</h3>
