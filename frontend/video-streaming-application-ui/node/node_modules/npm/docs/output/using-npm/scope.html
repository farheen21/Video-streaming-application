...
<section id="content">
  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <ul>
          <li><a href="#publishing-public-scoped-packages-to-the-primary-npm-registry">Publishing public scoped packages
            to the primary npm registry</a></li>
          <li><a href="#publishing-private-scoped-packages-to-the-npm-registry">Publishing private scoped packages to
            the npm registry</a></li>
        </ul>
  ...
  "@myorg/mypackage": "^1.3.0"
    ...
    <p>Scopes can be associated with a separate registry. This allows you to
      ...
      private registries, such as <a href="https://github.com/features/packages">GitHub Packages</a> or the open source
