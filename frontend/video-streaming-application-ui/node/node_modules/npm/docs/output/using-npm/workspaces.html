  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <li><a href="#running-commands-in-the-context-of-workspaces">Running commands in the context of workspaces</a>
        </li>
        <li><a href="#ignoring-missing-scripts">Ignoring missing scripts</a></li>
...
`-- packages
  ...
  "workspaces": [ "packages/b", "packages/a" ]
    ...
    <p>By running the command with the <code>--if-present</code> flag, npm will ignore workspaces missing target script.
    </p>
