  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <ul>
          <li><a href="#testing-whether-your-npmignore-or-files-config-works">Testing whether your
            <code>.npmignore</code> or <code>files</code> config works</a></li>
        </ul>
        <li><a href="#link-packages">Link Packages</a></li>
        <li><a href="#before-publishing-make-sure-your-package-installs-and-works">Before Publishing: Make Sure Your
          Package Installs and Works</a></li>
...
git+https://user@hostname/project/blah.git#commit-ish
    ...
    <h4 id="testing-whether-your-npmignore-or-files-config-works">Testing whether your <code>.npmignore</code> or <code>files</code>
      config works</h4>
