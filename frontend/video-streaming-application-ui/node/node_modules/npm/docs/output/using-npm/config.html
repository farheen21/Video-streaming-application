    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <ul>
          ...
          <li><a href="#install-strategy"><code>install-strategy</code></a></li>
          ...
          <li><a href="#lockfile-version"><code>lockfile-version</code></a></li>
          <li><a href="#loglevel"><code>loglevel</code></a></li>
          <li><a href="#logs-dir"><code>logs-dir</code></a></li>
          ...
          <li><a href="#omit-lockfile-registry-resolved"><code>omit-lockfile-registry-resolved</code></a></li>
          ...
          <li><a href="#replace-registry-host"><code>replace-registry-host</code></a></li>
          ...
          <li><a href="#workspaces-update"><code>workspaces-update</code></a></li>
...
ca[]="..."
    ...
    <p>The name of a continuous integration system. If not set explicitly, npm will
      ...
      <a href="http://npm.im/ci-info"><code>ci-info</code></a> module.</p>
    ...
    <p>The default behavior is to replace package dist URLs from the default
      registry (<a href="https://registry.npmjs.org">https://registry.npmjs.org</a>) to the configured registry. If set
      to
    ...
    <ul>
      <li>Default: <code>true</code> unless when using <code>npm update</code> where it defaults to <code>false</code>
      </li>
      <li>Type: Boolean</li>
    </ul>
...
npm init --scope=@foo --yes
    ...
    <p>The shell to use for scripts run with the <code>npm exec</code>, <code>npm run</code> and <code>npm init &lt;package-spec&gt;</code>
      commands.</p>
    ...
    <ul>
      <li>Default: false on windows, true on mac/unix systems with a unicode locale,
        as defined by the <code>LC_ALL</code>, <code>LC_CTYPE</code>, or <code>LANG</code> environment variables.
      </li>
      <li>Type: Boolean</li>
    </ul>
